fn main() {
     ...
     *
     * Referências devem referenciar algo, isso é, não são permitidas referências a coisas que
     * saíram de escôpo. Uma função não pode criar um valor como uma String e retornar sua
     * referência, pois a String em si sai de escôpo ao final da função. A String deve ser passada
     * diretamente, de maneira que sua posse é transferida.
     */
